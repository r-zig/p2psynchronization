...
{
    /// <summary>
    /// base business logic request message that used when want to mix message contract to allow infrastructure 
    ...
    public abstract class BusinessLogicRequestBase : BusinessLogicMessageBase
    {
    }
}