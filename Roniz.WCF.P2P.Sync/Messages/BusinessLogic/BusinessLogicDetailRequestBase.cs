...
{
    /// <summary>
    /// base business logic detail request message that used when want to mix message contract to allow infrastructure 
    ...
    public abstract class BusinessLogicDetailRequestBase:BusinessLogicRequestBase
    {
    }
}
