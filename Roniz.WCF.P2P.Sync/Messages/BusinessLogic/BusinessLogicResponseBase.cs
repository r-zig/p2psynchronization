...
{
    /// <summary>
    /// base business logic response message that used when want to mix message contract to allow infrastructure 
    ...
    public abstract class BusinessLogicResponseBase : BusinessLogicMessageBase
    {
    }
}